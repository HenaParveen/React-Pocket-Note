...
import { NotePopupModel } from "../notesPopupModel/NotePopupModel";
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.group_container}>
        {groups?.length === 0 && <p style={{ textAlign: "center" }}></p>}
      ...
      <NotePopupModel openModal={openModal} setOpenModal={setOpenModal} />
    </div>
  );
};
